...
Always provide prototype, small-production, expected-production, and high-growth scenarios. Separate
compute, database, storage, traffic/CDN, workers, cache/search/queue, observability, backups, staging,
secrets, notifications, third-party APIs, AI APIs, and disaster recovery when applicable.

Default to provider-neutral quantities, units, and formulas. When load is unknown, state scenario
